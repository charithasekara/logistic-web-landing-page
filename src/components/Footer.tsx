    ...
    <footer className="bg-gray-900 text-gray-200 py-16 px-4 md:px-16">
        ...
        <div className="lg:col-span-2">
          ...
          <form className="flex flex-col sm:flex-row gap-4">
            <input
              ...
              className="w-full px-4 py-2 rounded-md text-gray-900 placeholder-gray-500 bg-white border border-gray-300 focus:ring-2 focus:ring-yellow-400 focus:outline-none"
              required
            />
      ...
      <div className="border-t border-gray-700 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
        ...
        <div className="flex space-x-4 mt-4 md:mt-0">
          <a href="#">
            <IconBrandFacebook className="w-5 h-5 hover:text-white" />
          </a>
          <a href="#">
            <IconBrandTwitter className="w-5 h-5 hover:text-white" />
          </a>
          <a href="#">
            <IconBrandLinkedin className="w-5 h-5 hover:text-white" />
          </a>
          <a href="#">
            <IconMail className="w-5 h-5 hover:text-white" />
          </a>
        </div>
      </div>
    </footer>
